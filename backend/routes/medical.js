...
//post medical record
router.get("/add-record", async function (req, res, next) {
...
//post consentTo
router.get("/modify-consent", async function (req, res, next) {
    const { patientId, medicalRecordId, consentTo } = req.body;
